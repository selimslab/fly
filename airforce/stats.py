...
class TargetStats:
    ...
    target_updates_per_aircraft : Dict[str,int] = field(default_factory=lambda: collections.defaultdict(int))
    ...
    def add_target(self, target:dict):
        ...
        self.aircraft_with_the_min_number_of_target_updates = get_dict_key_with_the_min_value(self.target_updates_per_aircraft)
        self.min_number_of_target_updates = get_min_dict_value(self.target_updates_per_aircraft)
        
        self.aircraft_with_max_number_of_target_updates = get_dict_key_with_the_max_value(self.target_updates_per_aircraft)
        self.max_number_of_target_updates = get_max_dict_value(self.target_updates_per_aircraft)
